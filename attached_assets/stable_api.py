# python
from avalonaapi.api import Avalonaapi
import avalonaapi.constants as OP_code
import avalonaapi.country_id as Country
import threading
import time
import json
import logging
...
from avalonaapi.expiration import get_expiration_time, get_remaning_time
from avalonaapi.version_control import api_version
...
class Avalon:
    ...
    def connect(self, sms_code=None):
        ...
        self.api = Avalonaapi(self.email, self.password)
        check = None
