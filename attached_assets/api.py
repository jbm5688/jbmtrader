...
from avalonaapi.http.login import Login
from avalonaapi.http.loginv2 import Loginv2
from avalonaapi.http.logout import Logout
from avalonaapi.http.login2fa import Login2FA
from avalonaapi.http.send_sms import SMS_Sender
from avalonaapi.http.verify import Verify
from avalonaapi.http.getprofile import Getprofile
from avalonaapi.http.auth import Auth
from avalonaapi.http.token import Token
from avalonaapi.http.appinit import Appinit
from avalonaapi.http.billing import Billing
from avalonaapi.http.buyback import Buyback
from avalonaapi.http.changebalance import Changebalance
from avalonaapi.http.events import Events
from avalonaapi.ws.client import WebsocketClient
from avalonaapi.ws.chanels.get_balances import *

from avalonaapi.ws.chanels.ssid import Ssid
from avalonaapi.ws.chanels.subscribe import *
from avalonaapi.ws.chanels.unsubscribe import *
from avalonaapi.ws.chanels.setactives import SetActives
from avalonaapi.ws.chanels.candles import GetCandles
from avalonaapi.ws.chanels.buyv2 import Buyv2
from avalonaapi.ws.chanels.buyv3 import *
from avalonaapi.ws.chanels.user import *
from avalonaapi.ws.chanels.api_game_betinfo import Game_betinfo
from avalonaapi.ws.chanels.instruments import Get_instruments
from avalonaapi.ws.chanels.get_financial_information import GetFinancialInformation
from avalonaapi.ws.chanels.strike_list import Strike_list
from avalonaapi.ws.chanels.leaderboard import Leader_Board

from avalonaapi.ws.chanels.traders_mood import Traders_mood_subscribe
from avalonaapi.ws.chanels.traders_mood import Traders_mood_unsubscribe
from avalonaapi.ws.chanels.technical_indicators import Technical_indicators
from avalonaapi.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from avalonaapi.ws.chanels.get_order import Get_order
from avalonaapi.ws.chanels.get_deferred_orders import GetDeferredOrders
from avalonaapi.ws.chanels.get_positions import *

from avalonaapi.ws.chanels.get_available_leverages import Get_available_leverages
from avalonaapi.ws.chanels.cancel_order import Cancel_order
from avalonaapi.ws.chanels.close_position import Close_position
from avalonaapi.ws.chanels.get_overnight_fee import Get_overnight_fee
from avalonaapi.ws.chanels.heartbeat import Heartbeat


from avalonaapi.ws.chanels.digital_option import *
from avalonaapi.ws.chanels.api_game_getoptions import *
from avalonaapi.ws.chanels.sell_option import Sell_Option
from avalonaapi.ws.chanels.sell_digital_option import Sell_Digital_Option
from avalonaapi.ws.chanels.change_tpsl import Change_Tpsl
from avalonaapi.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from avalonaapi.ws.objects.timesync import TimeSync
from avalonaapi.ws.objects.profile import Profile
from avalonaapi.ws.objects.candles import Candles
from avalonaapi.ws.objects.listinfodata import ListInfoData
from avalonaapi.ws.objects.betinfo import Game_betinfo_data
...
class Avalonaapi(object):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self,username, password, proxies=None):
        ...
        self.host = "trade.avalonbroker.com"
